...
function handleCreateAssignment() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const res = yield fetchAPI(`/groups/${appState.currentCourseId}/assignments`, {
                method: 'POST',
                body: JSON.stringify(data)
            });
            if (res.ok) {
...
function saveGrade(submissionId) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (val === '')
            return;
        try {
            const res = yield fetchAPI(`/submissions/${submissionId}/grade`, {
                method: 'POST',
...
function analyzeEngagementDocs() {
    return __awaiter(this, void 0, void 0, function* () {
        const input = document.getElementById('engagement-pdf-input');
        if (!input.files || !input.files[0]) {
        ...
        try {
            ...
            const response = yield fetchAPI('/ai/analyze-engagement', {
                method: 'POST',
                body: formData,
...
function renderEngagementResults(data) {
    ...
    const buildList = (items, icon) => {
        if (!items || items.length === 0)
            return '<p class="text-muted fst-italic">No suggestions generated.</p>';
        return items.map(i => `
...
async function handleTeacherLeaveSubmit(event) {
    ...
    try {
        ...
        if (data.success) {
            alert('Leave application submitted successfully! Notification sent to Principal.');
            document.getElementById('teacher-leave-form').reset();
        } else {
            alert('Failed to submit leave: ' + (data.detail || "Unknown error"));
        }
    } catch (error) {
